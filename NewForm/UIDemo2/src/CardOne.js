...
export default class Card extends Component{
    ...
    return(
        <View style={{flex: 0.45,}}>
            ...
            <View style={{height: 70,width: "60%", marginLeft: 45, marginTop:130, position: 'absolute',}}>
                <Image source={require('../assets/whitebase.png')} />
                <View style={{ height: 50, width: 200, position: 'absolute', alignItems: 'center', paddingTop: 13, marginLeft: 45, marginTop: 5,}}>
                    <Text style={{fontWeight: 'bold', fontSize: 20}}>Roads Travelled</Text>
                    </View>
            </View>
        </View>
    );
