        ...
        return(
            <View style={{flex: 0.1, flexDirection: 'row',marginLeft: 20, marginRight: 20}}>
                ...
                <TouchableOpacity style={styles.button2Style}>
                    <Image style={{maxHeight: 60, maxWidth: 60}} source={require('./camera.png')} />
                </TouchableOpacity>
                <TouchableOpacity style={styles.button2Style}>
                    <Image style={{maxHeight: 60, maxWidth: 60}} source={require('./gallery.png')} />
                </TouchableOpacity>
                <TouchableOpacity style={styles.button2Style}>
                    <Image style={{maxHeight: 60, maxWidth: 60}} source={require('./plus.png')} />
                </TouchableOpacity>
                </View>
            </View>
        );
