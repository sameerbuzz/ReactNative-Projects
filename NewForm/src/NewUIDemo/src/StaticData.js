...
export default function Static() {
    return(
        <View style= {styles.mainStyle}>
            <Image source = {require('../assets/1566799228.png')} style ={styles.imgStyle}/>
            <View style={styles.fragView}>
                ...
                <View style={styles.eachCard}>
                    <Image source={require('../assets/first.png')} style={styles.badgeStyle}/>
                ...
                <View style={styles.eachCard}>
                    <Image source={require('../assets/second.png')} style={styles.badgeStyle}/>
                    <View style={styles.badgePrize}>
                        <Text style={styles.cardTextOne}>1st Prize</Text>
                ...
                <View style={styles.eachCard}>
                    <Image source={require('../assets/third.png')} style={styles.badgeStyle}/>
                    <View style={styles.badgePrize}>
                        <Text style={styles.cardTextOne}>1st Prize</Text>
            ...
            <View style={styles.descriptionStyle}>
                <View style={{flexDirection: "row", alignItems: 'center'}}>
                    <Image style={{aspectRatio: 1, height: 1}} source = {require('../assets/desc.png')} />
            ...
            <View style={styles.descriptionStyle}>
                <View style={{flexDirection: "row", alignItems: 'center'}}>
                    <Image style={{maxHeight: 60, maxWidth: 60}} source = {require('../assets/tick.png')} />
                        <Text style={{fontWeight: 'bold', fontSize: 20,}}>Rules</Text>
                        </View>
                    <View style={{ flexDirection: 'column', marginLeft: 40}}>
                        <View style={{flexDirection: 'row', paddingBottom: 6}}>
                            <Image style={{maxHeight:15, maxWidth: 15}} source={require('../assets/green.png')} />
