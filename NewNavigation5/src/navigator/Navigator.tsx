...
const HomeNavigator = () => (
  <HomeStack.Navigator headerMode='screen' initialRouteName="MyMap">
...
const ModalNavigator = () => (
  <ModalStack.Navigator initialRouteName="MarkerModal" mode='modal' >
    <ModalStack.Screen name={"MarkerModal"} component={MarkerModal} options={{
        ...
        <RootStack.Navigator headerMode='none'>
          {this.props.token === '' ?
            ...
            <>
              ...
              <RootStack.Screen name={"MarkerModal"} component={MarkerModal} options={{
                ...TransitionPresets.ModalSlideFromBottomIOS,
              }} />
            </>}
        </RootStack.Navigator>
